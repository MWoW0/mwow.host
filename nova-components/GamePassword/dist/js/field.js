...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-game-password', __webpack_require__(3));
    Vue.component('detail-game-password', __webpack_require__(6));
    Vue.component('form-game-password', __webpack_require__(9));
});
