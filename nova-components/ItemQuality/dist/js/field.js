...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-item-quality', __webpack_require__(3));
    Vue.component('detail-item-quality', __webpack_require__(6));
    Vue.component('form-item-quality', __webpack_require__(9));
});
...
var render = function() {
  ...
  return _c("span", { style: { color: _vm.option.color } }, [
          ...
          [
            ...
            _vm._l(_vm.field.options, function(option) {
              return _c(
                "option",
                {
                  class: _vm.textColor(option.color),
                  domProps: {
                    value: option.value,
