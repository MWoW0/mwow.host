<template>
    <div>
        <heading class="mb-6">Trinitycore Compiler</heading>
        ...
        <card class="bg-90 flex flex-col items-center justify-center" style="min-height: 300px">
            ...
            <button class="text-white text-4xl text-90 font-light mb-6" :disabled="deploying" @click="callDeploy">
                Start
                <i class="fa fa-spinner fa-spin" v-if="deploying"></i>
            </button>
