...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-item-display-id', __webpack_require__(3));
    Vue.component('detail-item-display-id', __webpack_require__(6));
    Vue.component('form-item-display-id', __webpack_require__(12));
});
...
var render = function() {
  ...
  return _c("panel-item", { attrs: { field: _vm.field } }, [
    _c("div", { attrs: { slot: "value" }, slot: "value" }, [
      ...
      _c("img", {
        staticClass: "block h-16 sm:h-24 sm:mb-0 sm:mr-4 sm:ml-0",
        attrs: { src: _vm.imageUrl, alt: _vm.field.icon }
      }),
      _vm._v(" "),
            ...
            _vm.field.downloadable
              ? _c(
                  "a",
                  {
                    ...
                    attrs: {
                      dusk: _vm.field.attribute + "-download-link",
                      tabindex: "0"
                    },
                    on: {
