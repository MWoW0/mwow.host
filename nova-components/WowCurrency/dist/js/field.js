...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_v_mask__ = __webpack_require__(18);


Nova.booting(function (Vue, router, store) {
    Vue.use(__WEBPACK_IMPORTED_MODULE_0_v_mask__["a" /* default */]);

    Vue.component('index-wow-currency', __webpack_require__(3));
    Vue.component('detail-wow-currency', __webpack_require__(6));
    Vue.component('form-wow-currency', __webpack_require__(9));
});
    ...
    [
      _c("template", { slot: "field" }, [
        _c("input", {
          ...
          domProps: { value: _vm.preparedValue },
          on: {
            change: function($event) {
              _vm.preparedValue = $event.target.value
            }
          }
        })
      ])
